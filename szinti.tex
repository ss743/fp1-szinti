...
Zur Signalverarbeitung werden Geräte des NIM-Standards ("Nuclear Instrument Module") verwendet, der sich in der Teilchenphysik bewehrt hat.\\
...
Nachfolgend ist der Versuchsaufbau für die verschiedenen Teile des Versuchs erklärt sowie die Versuchsdurchführung protokolliert.
...
Auf Grund der besseren Energieauflösung anorganischer Szintillatoren wird in diesem Versuchsteil  der NaI-Szintillator verwendet. Die Probe wird in einem Bleiblock mit einer Öffnung in Richtung des Szintillators befestigt. \\
...
Der Versuchsaufbau und die verwendete Schaltung für diesen Versuchsteil kann Abbildung \ref{SB2} entnommen werden.
...
\newpage
\subsection{Winkelabhängigkeit der Paarvernichtung}\label{winkel}
...
In Abbildung \ref{natriumspektren} sind die Energiespektren der Proben aufgetragen. In Abbildung \ref{natriumactivities} sind die Gesamtaktivitäten der Proben zu sehen. Dabei fällt auf, dass die Aktivität der ältesten Probe nicht die geringste Aktivität hat, sondern eine deutlich höhere Aktivität als die nächsjüngere Probe. Dies lässt am angegeben Alter der Probe schließen, da uns keine genauen und verlässlichen Angaben zum Alter der Proben vorliegen. Es könnte allerdings auch an einer höheren Anfangsmasse der Proben im Vergleich zu den anderen Proben liegen. Andererseits stellt sich dann die Frage, warum die Probe dann durch eine deutlich schlechtere Probe ersetzt wurde.

\subsubsection{Untersuchung einer Natriumprobe zu verschiedenen Zeitpunkten}
Anschließend wollten wir die Aktivität der Probe 4 aus Kapitel \ref{alter} in Abhängigkeit der Zeit bestimmen.
