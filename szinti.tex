...
Im dritten Teil des Versuchs, den verschiedenen Natriumproben, erhielten wir keine sinnvollen Ergebnisse.
...
Um $\gamma$-Strahlung detektieren zu können, muss die $\gamma$-Strahlung mit Materie wechselwirken. Wir unterscheiden dabei grundsätzlich drei Prozesse: Den Photoeffekt, den Compton-Effekt und die Paarbildung.
 ...
 Bei der Paarbildung entsteht durch die Wechselwirkung des $\gamma$-Quants mit dem elektromagnetischen Feld des Atomkerns oder eines Elektrons ein Teilchen-Antiteilchen-Paar, z.B. Elektronen-Positronen-Paar.Paarbildung ist für Energien über $1,022$ MeV möglich. Die über diesen Grenzwert hinausgehende Energie wird auf die entstandenen Teilchen übertragen, der Imuls wird vom Kern aufgenommen. Da das Positron nicht lange alleine existieren kann, vereinigt es sich unter Abstrahlung von zwei $\gamma$-Quanten mit einer Enrgie von je 511 keV mit einem Elektron. Auf Grund der Impulserhaltung wird für die beiden $\gamma$-Quanten ein Winkel von 180° erwartet. \textsuperscript{\cite{anleitung}}
 ...
 Das Outputsignal des Plastikszintillationszählers nach VOrverstärker ist in Abbildung \ref{soidgj} dargestellt. Es hat eine Breite von einigen hundert Nanosekunden.\textsuperscript{\cite{staat}}
 
 \graShort[0.5]{Outputsignal eines Plastikszintillators}{Plastik-Szinti}{Das Outputsignal des Plastikszintillators nach Vorverstärker auf dem gelben Kanal  \label{soidgj}}
...
In Abbildung \ref{europiumbild} ist das Spektrum der Europiumprobe mit den Gaußfits zu sehen. Wie bisher sind die bekannten Peaks rot und die unbekannten Peaks rosa eingezeichnet. Zur Energiekalibrierung verwenden wir von Europium die beiden bekannten Peaks der höchsten Intensitäten.
\newpage
